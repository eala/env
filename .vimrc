...
" use with --ignorecase or --sort=yes
...
" Use following commands in vim to manage plugin
" :PlugInstall, :PlugStatus, :PlugUpdate, :PlugUpgrade
call plug#begin()
Plug 'scrooloose/nerdtree'
Plug 'https://github.com/yegappan/taglist.git'
Plug 'https://github.com/wenlongche/SrcExpl.git'
